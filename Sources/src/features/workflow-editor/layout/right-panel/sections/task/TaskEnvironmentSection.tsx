 ...
 * @brief Section for managing environment variables of a task node.
 * @author Silvia Šlachtovská
 *
 * Allows users to define environment variables passed to the task execution.
 */

import styles from '../../RightPanel.module.css';
import type { EnvVar, WorkflowNode } from '../../../../../../domain/workflow/model/model';
