 ...
 * @brief Section for configuring batch execution settings.
 * @author Silvia Šlachtovská
 *
 * Provides UI for configuring execution parameters specific to batch systems
 * such as Slurm or PBS (e.g. resources, queue, runtime).
 */
